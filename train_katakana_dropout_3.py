...
class Three_ConvNet:
    def __init__(self, input_dim=(1, 28, 28), 
                 ...
                 hidden_size=100, output_size=15, dropout_ratio=0.5): # dropout_ratioを追加
        ...
        # 全結合層 (Poolingを1回サボるので 7x7=49ピクセル相当)
    ...
    def predict(self, x, train_flg=False):
        ...
        for layer in self.layers:
            # ★修正: Dropout層にも train_flg を渡す必要がある
    ...
    def accuracy(self, x, t, batch_size=100):
        ...
        for i in range(int(x.shape[0] / batch_size)):
            ...
            y = self.predict(tx, train_flg=False) # テスト時はDropoutが無効になる
...
def augment_data_aggressive(x, t):
    ...
    for angle in angles:
        ...
        for i in range(N):
            ...
            scale = np.random.uniform(0.85, 1.15) # よりアグレッシブに
...
network = Three_ConvNet(input_dim=(1,28,28), hidden_size=100, output_size=15, dropout_ratio=0.5)
